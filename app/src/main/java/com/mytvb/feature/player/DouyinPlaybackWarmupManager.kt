...
internal class DouyinPlaybackWarmupManager(
    ...
    suspend fun warmup(playInfo: com.mytvb.model.player.PlayInfoModel, selection: VideoPlayerStreamResolver.SelectionSnapshot) {
    ...
    private fun buildTargets(
        playInfo: com.mytvb.model.player.PlayInfoModel,
