...
import com.mytvb.core.lifecycle.AppBackgroundMonitor
...
class VideoPlayerFragment : Fragment() {
    ...
    private val douyinModeManager: com.mytvb.feature.player.douyin.DouyinModeManager by inject()
     ...
     * 与 [com.mytvb.core.common.media.VideoCodecSupport.isHardwareDecoder] 同款规则，
    ...
    private val playerListener = object : Player.Listener {
        ...
        override fun onIsPlayingChanged(isPlaying: Boolean) {
            ...
            if (isPlaying && !isSeeking) {
                ...
                com.mytvb.core.common.content.TeenModeTimer.onPlayStart()
            } else if (!isPlaying) {
                ...
                com.mytvb.core.common.content.TeenModeTimer.onPlayStop()
            }
            syncPlaybackEnvironment()
        }
    ...
    private fun renderDouyinTargetHeader(video: com.mytvb.model.video.VideoModel) {
        playerView.setTitle(video.title)
    ...
    private fun startDouyinQueueInitialization(currentVideo: com.mytvb.model.video.VideoModel) {
...
private fun com.mytvb.model.video.VideoModel.toDouyinPreview(): DouyinModePreview {
...
private fun com.mytvb.model.video.VideoModel.douyinDebugId(): String {
    return "aid=$aid,bvid=$bvid,title=${title.take(18)}"
}

private fun com.mytvb.model.video.VideoModel.douyinIdentityKey(): String {
...
private fun com.mytvb.model.video.VideoModel.isSameDouyinVideo(other: com.mytvb.model.video.VideoModel?): Boolean {
