...
import com.mytvb.feature.player.danmaku.common.BiliDanmakuFilterPolicy
...
import com.mytvb.feature.player.danmaku.common.DanmakuUserFilter
import com.mytvb.feature.player.danmaku.common.DanmakuUserFilterRepository
import com.mytvb.feature.player.danmaku.common.LiveDanmakuBatcher
import com.mytvb.feature.player.danmaku.common.LiveDanmakuController
import com.mytvb.feature.player.danmaku.common.VipDanmakuTextureCache
 ...
 * [com.mytvb.feature.player.view.MyPlayerView] 以引擎中立接口驱动。
 *
 * 职责：
...
class BlblDanmakuController(
    ...
    private fun flushLiveEmissionBuffer() {
        ...
        for (item in liveEmissionBuffer) {
            item.copy(
                progress = positionMs,
                mode = com.mytvb.feature.player.danmaku.common.DanmakuProtocolMode.ROLLING,
    ...
    /**
     * 设置面板 textSize(30-100) → textSizeScale。
     *
     * 30-55 映射表沿用已移除功能向引擎的 toDanmakuTextScale，保证档位视觉不变；
     * 56-100 为超宽/低密度屏新增，自 55 档线性外推（每档 +0.13），100 档约 8.65，
     * 在 density≈1.0 的 5120×1600 屏上字号约为 55 档的 3 倍。
     */
    private fun Int.toBlblTextScale(): Float = when {
        this < 30 -> 0.55f
        this <= 55 -> when (this) {
