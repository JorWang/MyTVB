...
import com.mytvb.databinding.CellDebugLogBinding
    ...
    inner class ViewHolder(
        ...
        fun bindFocusState(isFocused: Boolean) {
            ...
            binding.root.animate()
                ...
                .start()
            if (isFocused) {
                binding.root.setBackgroundResource(com.mytvb.R.drawable.cell_background)
            } else {
                binding.root.setBackgroundResource(com.mytvb.R.drawable.cell_setting_background)
            }
        }
    }
}