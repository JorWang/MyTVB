...
import com.mytvb.model.live.LiveDUrlModel
import com.mytvb.model.live.LivePlayUrlDataModel
import com.mytvb.model.live.LiveQualityModel
import com.mytvb.model.live.LiveRoomItem
import com.mytvb.model.live.LiveAreaCategoryParent
import com.mytvb.model.live.LiveListWrapper
...
class LiveRepository(
    ...
    suspend fun getLiveRecommend(): Result<LiveListWrapper> {
        return runCatching {
            com.mytvb.network.api.BiliApi.liveHomeList()
        }
    }
